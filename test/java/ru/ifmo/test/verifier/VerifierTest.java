 ...
 */
public class VerifierTest extends AbstractVerifierTest {
    ...
    public void testIsInStatePredicate1() throws LtlParseException {
        List<IInterNode> stack = verifier.verify("G(!isInState(A1, A1[\"leave bounds\"]))", predicates);
        assertFalse(stack.isEmpty());
        printStack(stack);
    }

    public void testIsInStatePredicate2() throws LtlParseException {
        List<IInterNode> stack = verifier.verify("G(!isInState(A1, A1[\"do maneuver\"]))", predicates);
        assertFalse(stack.isEmpty());
        printStack(stack);
    }

    public void testWasEventPredicate1() throws LtlParseException {
        List<IInterNode> stack = verifier.verify("G(!wasEvent(p1.e5))", predicates);
        assertFalse(stack.isEmpty());
        printStack(stack);
    }

    public void testWasEventPredicate2() throws LtlParseException {
        List<IInterNode> stack = verifier.verify("G(!wasEvent(p1.e2))", predicates);
        printStack(stack);
        assertTrue(stack.isEmpty());
    }

    public void testWasInStatePredicate1() throws LtlParseException {
        List<IInterNode> stack = verifier.verify("R(isInState(A1, A1[\"do maneuver\"]), wasInState(A1, A1[\"move to player\"]))",
                                                 predicates);
        printStack(stack);
        assertFalse(stack.isEmpty());
    }
    ...
    public void testWasInStatePredicate2() throws LtlParseException {
        List<IInterNode> stack = verifier.verify("G(!isInState(A1, A1[\"do maneuver\"]) || wasInState(A1, A1[\"move to player\"]))",
                                                 predicates);
        printStack(stack);
        assertFalse(stack.isEmpty());
    }
    ...
    public void testWasInStatePredicate4() throws LtlParseException {
        List<IInterNode> stack = verifier.verify("G(!(isInState(A1, A1[\"move to player\"]) && wasEvent(p1.e1)) " +
    ...
    public void testUUU() throws LtlParseException {
        List<IInterNode> stack = verifier.verify("G(!isInState(A1, A1[\"move to player\"])" +
    ...
    public void testUU() throws LtlParseException {     
        List<IInterNode> stack = verifier.verify("G(!(isInState(A1, A1[\"create new\"]) " +
