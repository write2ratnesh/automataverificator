/**
 * StatemachineWriter.java, 11.06.2008
 */
package ru.ifmo.test.automata.statemachine.impl;
...
public class StatemachineWriter {
    ...
    private static final StatemachineWriter instance = new StatemachineWriter();

    public static StatemachineWriter getInstance() {
        return instance;
    }

    private StatemachineWriter() {}

    public void write(String fileName, StatemachineContext context) throws IOException {
